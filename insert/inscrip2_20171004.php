		...
		if($sw == 2){
			...
			if( $mailing2 != ''){
				...
				//$correo="<p style='font-family:Arial;font-size:12px;line-height:16px;align:justify'>Se�or Usuario, gracias por registrase en el evento $rowmail[nom_evento], programado para el d�a $pru $fdia de $mes a las $rowmail[hora] en el $rowmail[lugar].";
                                $correo="<p style='font-family:Arial;font-size:12px;line-height:16px;align:justify'>Señor Usuario, gracias por registrase en el evento $rowmail[nom_evento].
				Recuerde presentar el Codigo de Inscripcion y estar en el sitio del evento 15 minutos antes de su inicio. 
<br><br>
</p>
<b><i>Su codigo de Inscripcion</i></b>
<table align=center >
<thead>
<tr><th>Codigo</th><th>Identificacion</th><th>Inscrito</th></tr>
</thead>
<tbody>	
	$codd
	$coddm
...
<p>";
if( $rowsql['pago'] == 1 ){
$pdias=array("domingo","lunes","martes","mi�rcoles" ,"jueves","viernes","s�bado");
...
$correo.="Para garantizar su cupo en el evento recuerde realizar su pago antes del $fpru $fpdia de $pmes de $fpanio y enviar el soporte a trav�s del correo electr�nico eventos@ccas.org.co
</p>";
}

$correo.="<p><b><i>Por favor no contestar a este mensaje, ha sido enviado desde una cuenta autom�tica y no recibir� respuesta.</i></b></p>";
