		...
		function () {
			...
			if (!jQuery('#ptTimeSelectCntr').length) {
				jQuery("body").append(
					...
					+	'								<a class="ptTimeSelectHr ui-state-default" href="javascript: void(0);" style="display: block; width: 45%; float: left;">CRA</a>'
					+	'								<a class="ptTimeSelectHr ui-state-default" href="javascript: void(0);" style="display: block; width: 45%; float: left;">CLLE</a>'
					+	'								<a class="ptTimeSelectHr ui-state-default" href="javascript: void(0);" style="display: block; width: 45%; float: left;">DIAG</a>'
					...
					+	'								<a class="ptTimeSelectMin ui-state-default" href="javascript: void(0);" style="display: block; width: 54%; float: left;">Carrera</a>'
					+	'								<a class="ptTimeSelectMin ui-state-default" href="javascript: void(0);" style="display: block; width: 54%; float: left;">Calle</a>'
					+	'								<a class="ptTimeSelectMin ui-state-default" href="javascript: void(0);" style="display: block; width: 54%; float: left;">Diagonal</a>'
					+	'								<br style="clear: left;" /><div></div>'
					+	'							</div>'
					+	'						</div>'
					+	'					</div>'
