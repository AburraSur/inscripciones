				...
				<form id="estados" >
					<font face="Verdana" size="3" ><b><i>Seleccione Evento</i></b></font>
						...
						<div id="resulestado" style="display:none" >
							...
							<br>
							<center><a href="#" id="inscrito" class="boton botonest" value="0" >Inscrito</a><a href="#" id="asistio" class="boton botonest" value="1" >Asistio</a><a href="#" id="cancelado" class="boton botonest" value="3" >Cancelado</a></center>
						</div>
					</div>
		</div>
...
<div style="display:block" ><input type="text" id="divpass" /><input type="text" id="divuser" /><input type="text" id="divperf" /></div>
	</body>
