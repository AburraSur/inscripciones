...
if ( $typ == 1 ){
	if( $n == 0){
		$sql = $db->consulta("select a.cedula,a.nombres,a.apellidos,a.email,ea.e_asistio 'asis',ea.id 'cod' from asistentes a inner join event_asist ea where a.cedula=ea.cedula and ea.idevent=$ideve ");
	}elseif( $n == 1){
		$sql = $db->consulta("select a.cedula,a.nombres,a.apellidos,a.email,ea.e_asistio 'asis',ea.id 'cod' from asistentes a inner join event_asist ea where a.cedula=ea.cedula and ea.idevent=$ideve and ea.cedula=$id ");
	}elseif( $n == 2){
		$sql = $db->consulta("select a.cedula,a.nombres,a.apellidos,a.email,ea.e_asistio 'asis',ea.id 'cod' from asistentes a inner join event_asist ea where a.cedula=ea.cedula and ea.idevent=$ideve and a.nombres like'%$id%' ");
	}elseif( $n == 6){
		$sql = $db->consulta("select a.cedula,a.nombres,a.apellidos,a.email,ea.e_asistio 'asis',ea.id 'cod' from asistentes a inner join event_asist ea where a.cedula=ea.cedula and ea.idevent=$ideve and a.apellidos like'%$id%' order by apellidos ASC ");
	}else{
		$sql = $db->consulta("select a.cedula,a.nombres,a.apellidos,a.email,ea.e_asistio 'asis',ea.id 'cod' from asistentes a inner join event_asist ea where a.cedula=ea.cedula and ea.idevent=$ideve and ea.id=$id");
	}
	
}else{
	
	if( $n == 0){
		$sql = $db->consulta("select a.cedula,a.nombres,a.apellidos,a.email,ma.asistio 'asis' from asistentes a inner join mod_asis ma where a.cedula=ma.cedula and ma.idmod=$idmod  and ma.idevento=$ideve ");
	}elseif( $n == 1){
		$sql = $db->consulta("select a.cedula,a.nombres,a.apellidos,a.email,ma.asistio 'asis' from asistentes a inner join mod_asis ma where a.cedula=ma.cedula and ma.idmod=$idmod  and ma.idevento=$ideve and ma.cedula=$id ");
	}elseif( $n == 2){
		$sql = $db->consulta("select a.cedula,a.nombres,a.apellidos,a.email,ma.asistio 'asis' from asistentes a inner join mod_asis ma where a.cedula=ma.cedula and ma.idmod=$idmod  and ma.idevento=$ideve and a.nombres like'%$id%' order by apellidos ASC ");
	}else{	
		$sql = $db->consulta("select a.cedula,a.nombres,a.apellidos,a.email,ma.asistio 'asis' from asistentes a inner join mod_asis ma where a.cedula=ma.cedula and ma.idmod=$idmod  and ma.idevento=$ideve and ma.idmodasis=$id ");
	}
}
...
while( $row = $db->fetch_array($sql) ){
	...
	echo "<tr align=center >
			...
			<td><font face=Verdana size=2 ><span id=mail$i value=$row[email]  >$row[email]</span></font></td>
			<td>
