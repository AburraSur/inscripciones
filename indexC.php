    ...
    <div class="tab_container">
		...
		<br><br>
		  ...
		  <form name="form1" id="form1">
			...
			<tbody>
			<tr>
				<td><input type="text" name="fmod1" size="15" class="fecha" /></td><td><input type="text" name="modu1" size="80" /></td>
			</tr>
			</tbody>
			</table>
		...
		<?php
		if(isset($_SESSION['iduser'])){
			echo "<div id=work5 style='display:block' >";
			}else{
			
			echo "<div id=work5 style='display:none' >";
			}
		?>
